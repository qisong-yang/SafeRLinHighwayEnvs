...
if __name__ == '__main__':
    ...
    def launch_ppo_lagrangian(seed, env_name, coop):
        ppo_lagrangian(
            ...
            logger_kwargs = {"output_dir": f"./results/timeout_ppo_lag_{env_name}_coop{coop}_cost_lim_{args.cost_lim}_penalty_init_{args.penalty_init}_penalty_lr_{args.penalty_lr}_penalty_iters_{args.penalty_iters}_seed_{seed}"},
            render=False,
            max_ep_len=100,
            epochs=150,
